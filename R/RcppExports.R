...
#' 
#' @export
vb_lin_reg <- function(X, y, mu0, Sigma0, a0, b0, prior = 1L, tol = 1e-8, maxiter = 100L, verbose = FALSE) {
    .Call(`_varapproxr_vb_lin_reg`, X, y, mu0, Sigma0, a0, b0, prior, tol, maxiter, verbose)
}
...
#' 
#' @export
update_vb_lin_reg <- function(vb_fit, X, y, tol = 1e-8, maxiter = 100L, verbose = FALSE) {
    .Call(`_varapproxr_update_vb_lin_reg`, vb_fit, X, y, tol, maxiter, verbose)
}
